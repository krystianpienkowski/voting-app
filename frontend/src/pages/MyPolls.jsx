...
import { deletePollById, getMyPolls } from "../services/poll";
...
const ViewMyPolls = () => {
    ...
    const handleDeletePoll = async (pollId) => {
        ...
        try {
            ...
            enqueueSnackbar("Deleting poll failed", {
                variant: "error",
                autoHideDuration: 5000,
            });
        } finally {
                                ...
                                >
                                    ...
                                    <div className="space-y-3 mb-5">
                                        {options.map((option) => (
                                            <div
                                                key={option.id}
                                                className="flex items-center justify-between gap-3 px-4 py-3 rounded-xl border bg-gray-50 border-gray-200 text-gray-700"
                                            >
                                    ...
                                    <div className="mt-auto">
                                        ...
                                        <button
                                            ...
                                            className="w-full py-3 rounded-xl bg-red-600 text-white font-semibold hover:bg-red-700 disabled:bg-red-300 disabled:cursor-not-allowed transition"
                                        >
                                            Delete poll
                                        </button>
                                    </div>
